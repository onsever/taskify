...
const TaskItem = ({ name, description, startDate, endDate, completed }) => {
    return (
        <View className={"bg-secondary w-full rounded-2xl mb-2 p-4"}>
            ...
            <View className={"flex flex-row items-center gap-x-2"}>
                ...
                <Text className={"text-frenchGray"}>{startDate} - {endDate}</Text>
            </View>
